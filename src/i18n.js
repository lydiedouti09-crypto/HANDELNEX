  ...
  fr: {
    translation: {
      ...
      solutions: {
        ...
        app_tag: 'Application', discover: 'Découvrir la solution', scan: 'SCANNER POUR TÉLÉCHARGER', android: 'Application Android', back: 'Retour aux solutions', complete_description: 'Description complète',
      },
      actualites: {
      ...
      contact: {
        ...
        subject_options: { logistics: 'Logistique', commerce: 'Commerce et achats en ligne', delivery: 'Livraison', administrative: 'Services administratifs', import_export: 'Import et export', digital: 'Technologies et services numériques', travel: 'Voyage et billetterie', second_hand: "Biens d'occasion" },
        send: 'Envoyer', sent: 'Message envoyé',
        email_title: 'E-mail', location_title: 'Siège', location: 'HANDELNEX (haftungsbeschränkt) Hamburger Allee 102, 60486 Frankfurt am Main Deutschland',
      ...
      footer: {
        ...
        registration: "Tribunal d'immatriculation de Francfort-sur-le-Main, HRB 143394",
  ...
  en: {
    translation: {
      ...
      solutions: {
        ...
        app_tag: 'App', discover: 'Discover the solution', scan: 'SCAN TO DOWNLOAD', android: 'Android App', back: 'Back to solutions', complete_description: 'Full description',
      },
      actualites: {
      ...
      contact: {
        ...
        subject_options: { logistics: 'Logistics', commerce: 'Commerce and online shopping', delivery: 'Delivery', administrative: 'Administrative services', import_export: 'Import and export', digital: 'Technology and digital services', travel: 'Travel and ticketing', second_hand: 'Second-hand goods' },
        send: 'Send', sent: 'Message sent',
        email_title: 'Email', location_title: 'Headquarters', location: 'HANDELNEX (haftungsbeschränkt)Hamburger Allee 102, 60486 Frankfurt am Main Germany',
      ...
      footer: {
        ...
        registration: 'Register court Frankfurt am Main, HRB 143394',
  ...
  de: {
    translation: {
      ...
      solutions: {
        ...
        app_tag: 'App', discover: 'Lösung entdecken', scan: 'ZUM HERUNTERLADEN SCANNEN', android: 'Android-App', back: 'Zurück zu den Lösungen', complete_description: 'Vollständige Beschreibung',
      },
      actualites: {
      ...
      contact: {
        ...
        subject_options: { logistics: 'Logistik', commerce: 'Handel und Online-Einkauf', delivery: 'Lieferung', administrative: 'Verwaltungsdienste', import_export: 'Import und Export', digital: 'Technologie und digitale Dienste', travel: 'Reisen und Ticketing', second_hand: 'Gebrauchtwaren' },
        send: 'Senden', sent: 'Nachricht gesendet',
        email_title: 'E-Mail', location_title: 'Sitz', location: 'HANDELNEX (haftungsbeschränkt)Hamburger Allee 102, 60486 Frankfurt am Main Deutschland',
      ...
      footer: {
        ...
        registration: 'Registergericht Frankfurt am Main, HRB 143394',
  ...
  'pt-BR': {
    translation: {
      ...
      solutions: {
        ...
        complete_description: 'Descrição completa',
      },
      ...
      contact: {
        ...
        subject_options: { logistics: 'Logística', commerce: 'Comércio e compras online', delivery: 'Entrega', administrative: 'Serviços administrativos', import_export: 'Importação e exportação', digital: 'Tecnologia e serviços digitais', travel: 'Viagens e bilhetagem', second_hand: 'Bens usados' },
        ...
        email_title: 'E-mail',
        location_title: 'Sede',
        location: 'HANDELNEX (haftungsbeschränkt) Hamburger Allee 102, 60486 Frankfurt am Main Alemanha',
      ...
      footer: {
        ...
        registration: 'Tribunal de registro de Frankfurt am Main, HRB 143394',
        entreprise: 'EMPRESA',
        solutions: 'SOLUÇÕES',
