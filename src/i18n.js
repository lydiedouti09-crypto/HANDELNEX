  ...
  fr: {
    translation: {
      ...
      apropos: {
        ...
        desc: "HANDELNEX développe des services et des solutions dans plusieurs domaines afin de répondre à des besoins concrets et de créer de nouvelles opportunités.",
        btn: 'En savoir plus',
        infos: [
